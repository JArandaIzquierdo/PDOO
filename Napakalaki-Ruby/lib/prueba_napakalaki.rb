...
for m in monsters
 ...
 #Array de Tesoros
  ...
  tesoros << Treasure.new("Botas de investigacion", 0, 3,TreasureKind.SHOES)
  
  #Creacion de A prueba de babas
  tesoros << Treasure.new("A prueba de babas", 0, 2,TreasureKind.ARMOR)
  
  #Creacion de Casco minero
  tesoros << Treasure.new("Casco minero", 0, 2,TreasureKind.HELMET)
  
  #Creacion de Camiseta de la UGR
  tesoros << Treasure.new("Camiseta de la UGR", 0, 1,TreasureKind.ARMOR)
  
  #Creacion de Cuchillo de sushi arcano
  tesoros << Treasure.new("Cuchillo de sushi arcano", 0, 2,TreasureKind.ONEHAND)
  
  #Creacion de Hacha prehistorica
  tesoros << Treasure.new("Hacha prehistorica", 0, 2,TreasureKind.ONEHAND)
  
  #Creacion de Gaita
  tesoros << Treasure.new("Gaita", 0, 4,TreasureKind.BOTHHANDS)
  
  #Creacion de Escopeta de 3 caniones
  tesoros << Treasure.new("Escopeta de 3 caniones", 0, 4,TreasureKind.BOTHHANDS)
  
  #Creacion de La rebeca metalica
  tesoros << Treasure.new("La rebeca metalica", 0, 2,TreasureKind.ARMOR)
  
  #Creacion de Necro-comicon
  tesoros << Treasure.new("Necro-comicon", 0, 1,TreasureKind.ONEHAND)
  
  #Creacion de Linterna a 2 manos
  tesoros << Treasure.new("Linterna a 2 manos", 0, 3,TreasureKind.BOTHHANDS)
  
  #Creacion de Necrotelecom
  tesoros << Treasure.new("Necrotelecom", 0, 2,TreasureKind.HELMET)
  
  #Creacion de Necro-playboycon
  tesoros << Treasure.new("Necro-playboycon", 0, 3,TreasureKind.ONEHAND)
  
  #Creacion de Shogulador
  tesoros << Treasure.new("Shogulador", 0, 1,TreasureKind.BOTHHANDS)
  
  #Creacion de Tentaculo de pega
  tesoros << Treasure.new("Tentaculo de pega", 0, 2,TreasureKind.HELMET)
